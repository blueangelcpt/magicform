 ...
 */
	protected function _getModel($model) {
		...
		$this->fieldset[$model] = array('fields' => null, 'key' => $object->primaryKey, 'validates' => null, 'messages' => null);
		return $object;
	}
 ...
 */
	protected function _introspectModel($model, $key, $field = null) {
		...
		if ($key === 'validates' && !isset($this->fieldset[$model]['validates'])) {
			...
			$this->fieldset[$model]['messages'] = $messages;
		}
 ...
 */
	protected function _getValidationMessage($validationRules) {
 ...
 */
	protected function _initInputField($field, $options = array()) {
		...
		if (!empty($this->fieldset[$this->model()]['messages'][$this->field()])) {
			$result['title'] = $this->fieldset[$this->model()]['messages'][$this->field()];
